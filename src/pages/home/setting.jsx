                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-xl-12 px-md-5">
                                    ...
                                    <form onSubmit="">
                                        ...
                                        <div class=" d-flex mb-4 align-items-center justify-content-space-between bg-light w-100  rounded-pill">
                                            
                                            <div className='profile-pics'>
                                                <img src={Image?Image:"unknown.png" } alt=""/>
                                            </div>
                                            <div className="d-flex ms-lg-5 s_txtarea">
                                                <label class="col-xl-10 ms-md-4" style={{cursor:"pointer"}}>
                                                    
                                                    <span class="mx-lg-5" id="pics_click">change profile picture</span>
                                           ...
                                           <div>
                                                <span class="btn btn-dark btn-sm mx-2 text-align-center" onClick={handleCloudinary}>Change...</span>  
                                            </div>
                                        </div>
                                        <div class="d-flex position-relative ">
                                        <div class=" d-flex align-items-center justify-content-space-between bg-light w-100  rounded-pill">
                                            ...
                                            <div className="d-flex ms-lg-5 s_txtarea">
                                                <label class="col-xl-10 ms-md-4" style={{cursor:"pointer"}}>
                                                    ...
                                                    <span class="mx-lg-5 " id="pics_A_click">change avatar picture</span>
                                            ...
                                            <div > 
                                                <span class="btn btn-dark btn-sm mx-2 text-align-center align-self-right" onClick={handleCloudinaryAvatar}>Change...</span>
                                            </div>
                                        </div>
